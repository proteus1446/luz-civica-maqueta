...
const GLOSARIO = {
  ...
  dotacion_panel:
    "total: dotación total de funcionarios municipales (las 3 áreas juntas) · municipal/educacion/salud: cantidad TOTAL de funcionarios de cada área POR SEPARADO · municipal_detalle/educacion_detalle/salud_detalle: para cada área, el desglose de sus funcionarios por tipo de contrato — {área}_detalle.planta/contrata/honorarios/cdt/comunitarios (cdt = contrato Código del Trabajo; los valores de cada '_detalle' SUMAN el total simple de esa misma área, ej. municipal_detalle.planta+...+comunitarios = municipal). Si preguntan 'cuántos de contrata hay por sector/área', da los 3 números por separado: municipal_detalle.contrata, educacion_detalle.contrata, salud_detalle.contrata · gasto_personal: gasto total consolidado en remuneraciones de personal, en miles de $ · planta_pct: % de la dotación que está en calidad de planta (v/s contrata, honorarios, código del trabajo) · lim40: gasto en personal a contrata como % del límite legal (40% del gasto en personal de planta) — un valor >100% indica que se excede el límite legal",
