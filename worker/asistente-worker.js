...
GLOSARIO.panel =
  ...
  "alcalde: {nombre: nombre del alcalde en ejercicio · mediana: remuneración líquida MEDIANA mensual del alcalde durante el año — este es el valor correcto para responder \"cuánto gana\" o \"quién gana más/menos\" · min/max: remuneración líquida mínima/máxima registrada en algún mes de ese año (pueden incluir bonos, aguinaldos u otros pagos puntuales de un solo mes — NO son el sueldo habitual, no los uses para \"cuánto gana\" salvo que pregunten específicamente por el mes de mayor/menor pago) · grado: grado de la Escala Única de Sueldos (EUS) que determina el sueldo base del alcalde. La escala oficial va de 1 a 6, y funciona AL REVÉS de lo intuitivo: grado 1 es el sueldo MÁS ALTO (comunas grandes/capitales regionales), grado 6 es el MÁS BAJO (comunas pequeñas). Lo fija la ley según población y presupuesto de la comuna — no cambia con los años en el cargo ni lo decide la municipalidad. Muy ocasionalmente aparece grado 7 u 8 en los datos: es un error puntual de un solo año en la fuente oficial (SINIM), no un grado real — si te preguntan por uno de esos casos, acláralo así en vez de inventar una explicación}";
